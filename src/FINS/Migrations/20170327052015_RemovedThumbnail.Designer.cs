...
namespace FINS.Migrations
{
    ...
    [Migration("20170327052015_RemovedThumbnail")]
    partial class RemovedThumbnail
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("FINS.Models.Common.Tax", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("TaxId");
            ...
            modelBuilder.Entity("FINS.Models.Common.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FINS.Models.Common.UnitConversion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FINS.Models.Inventory.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FINS.Models.Inventory.ItemGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FINS.Models.Inventory.Item", b =>
                {
                    b.HasOne("FINS.Models.Inventory.ItemGroup", "ItemGroup")
                        .WithMany()
                        .HasForeignKey("ItemGroupId");

                    b.HasOne("FINS.Models.Common.Unit", "Unit")
                        .WithMany()
